    ...
    <section>
      <>
        <div className="flex">
          ...
          <div>
            <div className="text-gray-700 py-2 px-3 rounded-md bg-gray-100 relative lg:ml-5 ml-2 lg:mr-12  ">
              <p className="leading-6">
                {comment}
                <i className="uil-grin-tongue-wink-alt"></i>{" "}
              </p>
              <div className="absolute w-3 h-3 top-3 -left-1 bg-gray-100 transform rotate-45 "></div>
            </div>
