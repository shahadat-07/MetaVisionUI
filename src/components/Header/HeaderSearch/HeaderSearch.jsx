    ...
    <section>
      <div className={`relative hidden md:block`}>
        <input
          ...
          onBlur={toogleOut}
          type="text"
          className="py-2 lg:py-2.5 px-2 lg:pl-10 md:w-56 lg:w-96 bg-gray-100 focus:bg-gray-200  rounded-full placeholder:text-xs lg:placeholder:text-sm focus:ring-0"
        ...
        <div
          className={`absolute border shadow-xl w-96 p-5 bg-white  rounded-lg z-50 ${
            isBoxVisible ? "" : "hidden"
          }`}
        >
          <h4 className="font-semibold text-lg "> Recently </h4>
          <ul>
            <Person
